...
export function ContactForm() {
  ...
  return (
    <section className="w-full px-6 sm:px-8 lg:px-10 py-16 flex flex-col items-center">
      <h2 className="text-4xl text-center text-white mb-4">{t("title")}</h2>
      ...
      <form onSubmit={handleSubmit} className="w-full max-w-2xl flex flex-col gap-6">
        <div className="flex flex-col md:flex-row gap-4">
          <div className="flex-1 flex flex-col gap-1">
            <label htmlFor="contact-first-name" className="uppercase text-xs tracking-widest text-footer-light mb-1">
              {t("form.firstName")}
            </label>
            <input
              name="firstName"
          ...
          <div className="flex-1 flex flex-col gap-1">
            <label htmlFor="contact-last-name" className="uppercase text-xs tracking-widest text-footer-light mb-1">
              {t("form.lastName")}
            </label>
            <input
              name="lastName"
